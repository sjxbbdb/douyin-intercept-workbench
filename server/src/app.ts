...
function getFeatures(row: AnyRecord, providerConfigured: boolean) {
  ...
  return {
    evaluate: features.evaluate === true,
    draft: features.draft === true && providerConfigured,
    workflow: features.workflow !== false,
    videoSearch: features.videoSearch !== false,
    commentReply: features.commentReply !== false,
    liveInteraction: features.liveInteraction !== false
  };
}
