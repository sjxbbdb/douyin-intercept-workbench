...
const state = { view: 'tasks', data: null, ledger: [], endpoint: '', draftUrl: '', taskEditor: null, recheckPending: new Set(), search: { keyword: '', maxVideos: 20, minRelevance: 0, cursor: '', result: null, loading: false } };
