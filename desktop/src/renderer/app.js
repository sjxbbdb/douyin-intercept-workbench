...
function renderHeader() {
  ...
  $('#browser-status').textContent = browser.connected ? `抖音窗口已连接，匹配 ${browser.matchCount || 0}` : '抖音窗口未连接';
